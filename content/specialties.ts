...
export const specialties: Specialty[] = [
  ...
  },
  {
    ...
    accent: "accent",
    icon: Megaphone,
    summary: "Growth marketing built for accountancy firms.",
    metaTitle: "Marketing Services for Accountants",
    metaDescription:
      "SEO, PPC, social and content marketing built for accountancy firms — turn online visibility into qualified leads and measurable growth.",
    hero: {
      eyebrow: "Specialty",
      heading: "Marketing that turns visibility into clients",
      subheading:
        "A multi-channel approach — SEO, paid, social and content — designed to turn traffic into qualified leads and measurable growth for your practice.",
    },
    deliverables: [
      { title: "SEO", description: "Organic visibility for the searches that matter." },
      { title: "PPC advertising", description: "Paid campaigns that bring immediate, targeted reach." },
      { title: "Social media", description: "Channel management that builds audience and trust." },
      { title: "Content marketing", description: "Content that earns confidence and converts." },
      { title: "Strategy", description: "A plan tailored to your goals and market." },
      { title: "Analytics & reporting", description: "Transparent performance tracking, no vanity metrics." },
    ],
    benefits: [
      { title: "Stronger brand", description: "Tailored messaging that gets you noticed.", icon: Megaphone },
      { title: "Qualified leads", description: "Reach the right audience, not just more people.", icon: Search },
      { title: "Better ROI", description: "Data-led optimisation toward what works.", icon: BarChart3 },
      { title: "Measurable results", description: "Clear reporting on every pound spent.", icon: TrendingUp },
    ],
    faqs: [
      ...
      { question: "How is performance measured?", answer: "Through transparent analytics tied to real outcomes — traffic, leads and ROI — reported clearly, not buried in vanity metrics." },
    ],
    related: ["cloud-accounting", "ai-accounting"],
  },
];
